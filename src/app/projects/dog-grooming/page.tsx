...
export default function DogGroomingPage() {
  return (
<main className="project-blue w-screen overflow-x-hidden  h-[100svh] overflow-y-auto snap-y snap-mandatory scroll-smooth  text-white project-blue bg-black snap-page ">

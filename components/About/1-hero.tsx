...
const SKILLS: SkillIcon[] = [
  ...
  { src: "/images/skills/9.png", alt: "Sass.css", className: "left-[-6%] top-[52%] lg:left-[0%] lg:top-[58%]" },

  { src: "/images/skills/8.png", alt: "JavaScript", className: "right-[0%] top-[28%] lg:right-[-4%] lg:top-[60%]" },

...
const SKILLS: SkillIcon[] = [
  ...
  { src: "/images/skills/13.png", alt: "VS Code", className: "right-[33%] top-[3%] lg:right-[33%] lg:top-[19%]" },
  ...
  { src: "/images/skills/4.png", alt: "Google Analytics", className: "left-[8%] top-[70%] lg:left-[-4%] lg:top-[38%]" },

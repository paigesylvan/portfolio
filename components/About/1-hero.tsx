...
const SKILLS: SkillIcon[] = [
  ...
  { src: "/images/skills/4.png", alt: "Google Analytics", className: "left-[10%] top-[22%] lg:left-[-8%] lg:top-[26%]" },
  ...
  { src: "/images/skills/11.png", alt: "CSS", className: "right-[-3%] top-[37%] lg:right-[5%] lg:top-[40%]" },

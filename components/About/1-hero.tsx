...
const SKILLS: SkillIcon[] = [
  ...
  { src: "/images/skills/4.png", alt: "Google Analytics", className: "left-[-7%] top-[30%] lg:left-[-8%] lg:top-[26%]" },
  ...
  { src: "/images/skills/12.png", alt: "HTML", className: "right-[-7%] top-[50%] lg:right-[-10%] lg:top-[37%]" },
];

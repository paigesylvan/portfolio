...
const SKILLS: SkillIcon[] = [
  { src: "/images/skills/2.png", alt: "Shopify", className: "left-[7%] top-[13%] lg:left-[6%] lg:top-[10%]" },
  ...
  { src: "/images/skills/4.png", alt: "Google Analytics", className: "left-[-18%] top-[25%] lg:left-[-8%] lg:top-[26%]" },

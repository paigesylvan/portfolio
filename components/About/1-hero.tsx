...
const SKILLS: SkillIcon[] = [
  { src: "/images/skills/2.png", alt: "Shopify", className: "left-[6%] top-[18%] lg:left-[3%] lg:top-[18%]" },
  ...
  { src: "/images/skills/10.png", alt: "Tailwind.css", className: "left-[20%] top-[62%] lg:left-[3%] lg:top-[47%]" },

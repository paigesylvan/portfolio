...
export default function Project3Part3() {
  ...
  return (
    <section className="flex flex-col items-center justify-center px-4 text-white mt-18 pb-8 lg:pb-0 lg:mt-24 scale-[0.85] md:scale-[0.83] lg:scale-[0.8] origin-top">

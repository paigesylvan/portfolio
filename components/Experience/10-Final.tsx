          ...
          >
            ...
            <div className="text-center md:text-left mt-10 md:mt-20">
              ...
              >
                View Document
                <span
                  className="ml-2 flex items-center justify-center w-5 h-5 rounded-full bg-white/10 transition-all duration-300 group-hover:bg-[#D6A75E]/40 group-hover:translate-x-1"
                >
                  →
                </span>
              </Link>

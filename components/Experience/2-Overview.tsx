...
export default function OverviewMWES() {
  ...
  return (
    <section className="project-yellow flex min-h-[100svh] flex-col justify-center px-4 sm:px-6 py-10 md:py-16 text-white">
      <div className="w-full max-w-[1200px] mx-auto">
        ...
        {/* Content: single column on mobile; split on md+ */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
          ...
          <div>
            <div>
              ...
              <div className="rounded-xl bg-white/[0.04] ring-1 ring-white/10 p-3 text-white/85">
            ...
            {/* Skills: tight, wrapped grid; no scrolling */}
            <div className="mt-4">
              <p className="text-[10px] tracking-[0.22em] accent-text mb-2">
                UX/UI SKILLSET’S LEVERAGED
              </p>

              {/* Use negative margins + m- utilities to pack chips tightly */}
            ...
            {/* Stats at bottom on mobile: place after chips in DOM */}
          ...
          {/* Right: stats (desktop only, smaller + tidy) */}

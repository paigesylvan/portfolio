  ...
  return (
    <section className="flex min-h-[100svh] flex-col items-center justify-center px-3 sm:px-4 text-white mt-20 lg:mt-12 pb-6">
      <div className="max-w-[1000px] mx-auto">
        ...
        <p className="mx-auto mt-2 lg:mt-3 text-left text-white/80 text-[12px] md:text-[13px] leading-snug">
        ...
        <p className="mt-6 tracking-[0.18em] uppercase text-center text-[10px] md:text-[11px] text-[#00C67C] font-semibold">
          HOMEPAGE WIREFRAMES
        </p>
      </div>
    </section>

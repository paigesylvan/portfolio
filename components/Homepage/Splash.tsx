...
export default function Hero({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="vignette-soft absolute inset-0 pointer-events-none z-[1]"
        aria-hidden
      />
      ...
      <div className="relative z-10 mx-auto max-w-[1000] lg:max-w-[1090px] px-6 pt-24 pb-20 md:pt-28 lg:pt-32">
        <div className="grid items-left gap-14 lg:grid-cols-12">
          ...
          >
            ...
            {/* ✅ NEW subhead */}
            <motion.p
              className="mt-3 text-white/85 text-sm md:text-base leading-snug max-w-[56ch] mx-auto lg:mx-0"

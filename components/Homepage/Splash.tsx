      ...
      <div className="relative z-10 mx-auto max-w-[1100px] px-6 py-20 mt-[18vh] md:mt-[24vh] lg:mt-[27vh]">
        <div className="flex flex-col items-center text-center gap-10">
          ...
          <div>
            ...
            <h1
              id="hero-title"
              className="mt-2 text-5xl md:text-7xl lg:text-7xl font-staat tracking-[0.1em]"
            >
              {title}
            </h1>

            <p className="mt-8 text-white/95 text-[14px] md:text-[15px] px-4 md:px-12 lg:px-0 max-w-[500px] mx-auto mb-36 font-staat">
              {subtitle}
            </p>
          </div>

...
export default function Hero({
  ...
  return (
    ...
    >
      {/* Aurora background */}
      <div className="aurora-top absolute left-1/2 top-0 -translate-x-1/2 w-screen h-[1000vh] pointer-events-none z-0" />
      ...
      <div className="relative z-10 mx-auto max-w-[1100px] px-6 py-20 mt-[18vh] md:mt-[24vh] ">
        <div className="flex flex-col items-center text-center ">
          ...
          <Image
            ...
            height={300}
          />
            <p className="text-blue-700 text-[14px] md:text-[15px] px-4 md:px-12 lg:px-0 max-w-[450px] mx-auto mb-12 leading-snug text-left uppercase tracking-[0.18em]">
              {subtitle}
            </p>

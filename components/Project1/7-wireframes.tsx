...
export default function Wireframes() {
  ...
  return (
    <section className="px-4 sm:px-6 flex flex-col justify-center text-white py-10 md:py-14 mt-12 lg:mt-0">
      <div className="mx-auto w-full max-w-[1000px] lg:mt-12">
        {/* Copy */}
        <div className="w-full mb-2">
          <SectionHeader kicker="LOW-FI EXPLORATION" title="Key Wireframes" align="left" />

          <p className="mt-3 text-left text-white/75 text-[12px] lg:text-[13px] leading-snug mb-4">
            I began sketching early concepts of the pages. These quick sketches allowed me to explore
            layouts and content hierarchy. I tested different navigation bar options to see which would
            enhance usability and identified which items were most essential to feature. Wireframing
            helped me establish early structure for core flows; appointment creation, groomer discovery,
        ...
        {/* Wireframes grid */}
        <motion.div
          className="mx-auto mt-6 md:mt-8 grid w-full max-w-[720px] grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 justify-items-center"
          variants={parent()}
          initial="hidden"
          whileInView="show"
        ...
        >
          {wireframes.map((wf) => (
            ...
            >
              <div className="relative mx-auto aspect-[4/5] w-[110px] sm:w-[160px] md:w-[150px] lg:w-[160px] overflow-hidden rounded-lg ring-1 ring-white/10">
                <Image
                  src={wf.src}
                  alt={wf.alt}
                  fill
